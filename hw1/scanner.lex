...
(\"(.*)([^\\])((\\){2})*\\x.\")|(\"((\\){2})*\\x.\") 							return HEX_LENGTH_1;  /* fail on illegal hex character */
(\".*[^\\]((\\){2})*\\x\")|(\"((\\){2})*\\x\") 							return HEX_LENGTH_0;  /* fail on illegal hex character */ /*\"([^\n\r])*([^\\]\")+([.]{-}[\n\r])*\"				 	printf("illegal \" error\n");return ERROR;   /* fail on " */
