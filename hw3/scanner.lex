...
and                                 { yylval = new OpNode(yytext, yylineno); return AND; }
or                                  { yylval = new OpNode(yytext, yylineno); return OR; }
not                                 { yylval = new OpNode(yytext, yylineno); return NOT; }
...
{equalUnequal}				        { yylval = new OpNode(yytext, yylineno); return EQUALITY; }
{inequality}				        { yylval = new OpNode(yytext, yylineno); return RELATIONAL; }
{plusMinus}					        { yylval = new OpNode(yytext, yylineno); return ADDITIVE; }
{multDiv}					        { yylval = new OpNode(yytext, yylineno); return MULTIPLICATIVE; }
